...
- **Delegation (Human-AI Balance):** Decide how much Claude should handle versus how much you should handle, and articulate what the human brings to the task.
...
#### **Stage 3: DELEGATION (Human-AI Balance)**

You must decide how much Claude should handle vs. how much you should handle. Consider:

| Approach | When to Use |
|---------|------------|
| **Hand it off (Automation)** | Task is fully specified, inputs are clear, errors are easy to catch |
| **Collaborate (Augmentation)** | Task requires human relationship context, creative judgment, or stakeholder-specific tone |
| **Iterate together (Agency)** | Task requires ongoing interpretation and judgment throughout the process |

Here are the three modalities in full:
...
1. Can Claude handle this end-to-end, or does it need human judgment?
2. What brings the human to the table that Claude can't do? (Relationship context, strategic judgment, governance verification, etc.)
...
**Facilitator Reference:** The table below shows DC CAP's AI capabilities. Participants don't select from this table directly. It helps facilitators assess whether participants are thinking about the right kind of AI setup for their task.
...
When you use Claude, you'll decide how much Claude handles vs. how much you handle. Here are three common patterns:

**HAND IT OFF (Automation)** — Claude runs with minimal intervention.
...
**DRAFT TOGETHER (Augmentation)** — Claude drafts; you refine with judgment and context.
...
**FIGURE IT OUT TOGETHER (Agency)** — Claude and human iterate on complex problems.
...
#### Step 1c: Decide the Human-AI Balance (Delegation)

Before you run your prompt, make a judgment call about how this task should work between you and Claude.

**Question 1: Are you handing this off or collaborating?**

Think about the partner email you're about to ask Claude to write.
- **Hand it off:** You give Claude clear instructions, Claude produces the whole email, you check the result before sending. Works when the task is well-defined and you can easily spot errors.
- **Collaborate:** Claude gives you a starting draft, then you reshape it with things only you know — relationship history with specific partners, the right tone for each school, context about why certain partners are late. Works when human judgment and context matter throughout.

Which approach fits this partner email, and why?

**Question 2: What do you bring that Claude can't?**

Name the specific thing(s) you'd add, check, or change that Claude has no way of knowing. This is the human judgment layer — the reason a person needs to be in this loop.

**Your turn:**
- State whether you're handing off or collaborating, and explain your reasoning in 2-3 sentences.
- Name at least one specific thing you bring that Claude can't.
...
#### Step 2c: Decide the Human-AI Balance (Delegation)

Same judgment call, different task. Think about the data summary for board slides.

**Question 1: Are you handing this off or collaborating?**

For this data summary:
- The inputs are specific (six universities, three award types)
- The output format is defined (table for board slides)  
- You can verify the numbers against what you know

Does that sound like a task you hand off to Claude and check at the end? Or do you need to be involved throughout?

**Question 2: What's the one thing you need to verify that Claude definitely can't verify for itself?**

Think back to your Tier 2 classification. What's the governance check that only a human can make on this output?

**Your turn:**
- State your approach (hand off or collaborate) and explain why in 2-3 sentences.
- Name the specific verification only you can do.
...
### Dimension 2: Prompt Quality + Human-AI Balance

**What This Measures**
Your CTCC prompts include all four elements (Context, Task, Constraints, Content) and are specific to each sub-task. You articulate a clear and appropriate human-AI balance for each task with reasoning that demonstrates understanding of what Claude handles vs. what you handle.

**Why It Matters**
A good prompt activates the right AI capability and sets up the human to add their judgment effectively. Poor prompts lead to weak outputs that require heavy editing. Clear thinking about the human-AI balance ensures you're using Claude the way it's designed to be used — not overloading Claude with tasks that need human judgment, not wasting human time on tasks Claude can handle end-to-end.
...
- Your human-AI balance choices are correct and clearly reasoned (Collaborate for email — because tone/relationship context matter; Hand it off for data summary — because inputs are clear and errors are easily caught).
- Your reasoning explains WHY that balance makes sense. (E.g., "Collaborate for the email because I know these partners better than Claude does; I need to adjust tone and add context.")
- Your reasoning demonstrates integration of governance, prompt specificity, and clear articulation of what Claude handles vs. what you handle.
...
- Your human-AI balance choices are correct (Collaborate for email, Hand it off for data summary).
- Your reasoning explains the balance reasonably well (e.g., names the human-AI trade-off).
...
- Your human-AI balance choice is reasonable, but reasoning is weak.
- Your reasoning addresses the balance but doesn't fully explain why that approach fits the task. (E.g., "I'll collaborate because Claude needs help" vs. explaining what help Claude specifically needs or what context you'll add.)
...
- Human-AI balance choice is incorrect or reasoning is missing.
- Reasoning is unclear or shows misunderstanding of what Claude handles vs. what the human handles.
- No clear articulation of the human's role or contribution.

**Calibration Anchors (Approaching → Meets Boundary)**
- Meets requires: All four CTCC elements explicitly present + correct human-AI balance with a 2-3 sentence rationale that names the specific human-AI trade-off.
- Approaching shows three CTCC elements OR brief rationale ("Collaborate because Claude needs help") without explaining what help Claude specifically needs or what you specifically bring.
...
**C. Human-AI Balance Decision**
[Your approach and rationale from Stage 2, Step 1c]
...
**C. Human-AI Balance Decision**
[Your approach and rationale from Stage 2, Step 2c]
...
### TASK 1 HUMAN-AI BALANCE DECISIONS (Deterministic)

#### Sub-Task 1: Partner Reminder Email

**Appropriate Approach: Collaborate (Draft Together)**

**Reasoning:**
The email requires relationship context that Claude can't have. How responsive is Trinity typically? What tone works for GW? Should this be warm or firm? Claude can draft the email, but you must add relationship context and adjust tone.
...
- **Claude role:** Generate a professional, complete draft that's close to ready.
- **Risk if you handed it off without review:** You send Claude's output without relationship context, and the tone doesn't fit each institution.

---

#### Sub-Task 2: Data Summary

**Appropriate Approach: Hand It Off (Automation)**

**Reasoning:**
The task is fully specified. The inputs are clear: universities (6 specific names), award types (MSI, SAI, Last Dollar), output format (suitable for board slides). You're not asking Claude to interpret ambiguous requirements; you're asking for a specific analysis.

- **Human role:** Provide parameters, run the script/query, verify output against your database, check for governance concerns (small cells — the critical human verification).
- **Claude role:** Generate the complete, production-ready script or analysis.
- **Risk if you collaborated unnecessarily:** You'd slow down the task by iterating when the parameters are already clear and the output is easy to verify.
- **Critical human verification:** Before the board sees this, you must check cell sizes (N ≥ 10) — this is the one thing only you can verify.
