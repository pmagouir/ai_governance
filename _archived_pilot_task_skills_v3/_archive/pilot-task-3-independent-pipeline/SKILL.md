...
| Task | Deliverable + Audience + Frequency | Repeatable? | Describable? | Recoverable? | Quadrant | Rationale (2-3 sentences) | Human-AI Balance (if Deploy Now) | Governance Tier (if Deploy Now) |
|------|--------|--------|--------|--------|----------|----------|----------|----------|
| 1. Partner reminder email | Email to 6 university partners, weekly during deadlines | Yes | Yes | Yes | Deploy Now | All three tests pass. Highly recurring, data is organizational tier 3, errors caught in review. | Draft Together | Tier 3 |
| 2. ... | ... | ... | ... | ... | ... | ... | ... | ... |
...
- Decide the human-AI balance: Are you handing this off to Claude, drafting together, or figuring it out together?
  - **Hand It Off:** Claude runs the task end-to-end; you spot-check before release
  - **Draft Together:** Claude drafts; you rewrite/refine significantly
  - **Figure It Out Together:** Claude makes some decisions (e.g., categorization, routing) with your oversight
- Assign governance tier based on the data involved
- Explain your choice: What judgment do you bring that Claude can't? What does Claude handle?
...
### Stage 3: DELEGATION (Task Type + Human-AI Balance)

**What type of work is this?** Examples:
...
**Why this balance?** What judgment do you bring? What's Claude's role? What risks do you manage?
...
- Task type + human-AI balance + rationale
...
- Name the workflow: What type of work is this? What does Claude do? What does the human do?
...
- Example: "Workflow: Partner Outreach (Draft Together). Claude generates templated emails with variables filled in. I customize tone/relationships (5 min), verify against deadline policy, send. Time: 20 minutes for 6 emails."
...
2. **AFTER** (75-100 words): Workflow, task type, human role, Claude role, time now
...
> **Quadrant:** Deploy Now  
> **Rationale:** Recurs weekly during 4 months (high frequency). All three readiness tests pass—template structure, data is non-sensitive organizational info, errors caught before send. Governance: Tier 3 (partner contact info, deadline info). Human-AI balance: Draft Together (Claude drafts, human customizes for relationships). This is highest-ROI: 6 emails × 14 weeks = 84 emails/year, 90 min → 20 min each = 1,176 hours saved if scaled to 10 units.
...
> **Human-AI Balance:** Draft Together (draft + review)
...
- **Stage 3 (Delegation):** Task type and human-AI balance are sound; explanation demonstrates deep understanding of what you bring. You name specific things Claude can't do that you must handle.
...
> **Stage 3 Human-AI Balance:** Draft Together. Claude generates the breakdown; I verify cell sizes against raw data and check for any names that slipped in.  
...
- **Stage 3:** Task type and human-AI balance are appropriate; rationale shows understanding of what you bring
...
- **Stage 3:** Task type and human-AI balance are reasonable, but rationale is generic ("Claude helps because it's fast")
...
- **Stage 3:** Task type or human-AI balance choice is inappropriate; rationale shows misunderstanding of what you bring
...
- **After section:** Workflow is named (task type + human-AI balance). Human and Claude roles are clearly separated ("Claude drafts all 6; I customize tone based on relationships, then send").
...
> **After:** Partner Outreach (Draft Together). Workflow: (1) Run CTCC prompt with partner list + deadline, (2) Claude generates 6 templated emails with deadline, (3) I review tone and add 2-3 sentences customizing based on relationships I remember (5 min), (4) Verify all 6 partners are included, (5) Send. Time: 20 minutes (measured April 10 cycle).  
...
> **After:** Partner Outreach (Draft Together). Claude generates 6 emails using Partner Outreach prompt. I customize tone and verify all 6 are included. 20 minutes per cycle.  
...
- You name the teaching pathway: "In Q3, I'll teach [colleague] how to run this workflow, starting with why we classify this data as Tier 2 and what that means for the Claude prompt. I'll show them the human-AI balance (Draft Together) and have them help with the tone customization while I audit the governance compliance."
...
> Q3 teaching: I'll train my colleague on Partner Outreach by showing her the Tier 3 classification and why it means we can use Claude safely. She'll run the CTCC prompt on May's cohort while I observe and give feedback on the tone edits. We're using a "Draft Together" approach so she learns both the governance reasoning and the judgment pieces I bring.
...
Example (Meets):
> **Governance:** Partner emails are Tier 3 (institutional info). We can share partner names and deadline with Claude. The human verifies tone, policy accuracy, and that all partners are included. Our human-AI balance is "Draft Together"—Claude generates drafts, I customize for relationships.  
> **Teaching:** Next month I'll show [colleague] how to run this workflow and explain why Tier 3 classification means we can use Claude safely here.
...
- [ ] Stage 3 (Delegation): Human-AI balance rationale shows understanding of what the human does that Claude can't
...
- [ ] After section: Workflow named (task type + human-AI balance), roles separated (what Claude does, what human does), time now specified
...
- [ ] Part C impact evidence is consistent with the human-AI balance you chose in Part B
...
- Rewrite "After": Explicitly name the task type, the human-AI balance, and what Claude does vs. what you do.
...
| Task | Deliverable + Audience + Frequency | Repeatable? | Describable? | Recoverable? | Quadrant | Rationale | Human-AI Balance (if Deploy Now) | Governance Tier (if Deploy Now) |
|------|-----|-----|-----|-----|-----|-----|-----|-----|
| 1. Partner reminder emails | Email to 6 university partners, every Monday during application season (14x/year) | Yes | Yes | Yes | Deploy Now | Recurs weekly during 4 months. All three readiness tests pass—template structure, data is organizational tier 3, errors caught in review before send. Human-AI balance: Draft Together (Claude drafts, human customizes for relationships). | Draft Together | Tier 3 |
| ... | ... | ... | ... | ... | ... | ... | ... | ... |
...
1. [Task name, human-AI balance, tier, one-sentence impact rationale]
2. [Task name, human-AI balance, tier, one-sentence impact rationale]
...
*Task Type & Human-AI Balance*

- Task Type: [Name]
- Human-AI Balance: [Hand It Off / Draft Together / Figure It Out Together]
- Rationale: [2-3 sentences on what you bring and why this balance]
...
[75-100 words]
- Workflow (task type + human-AI balance)
- Human role
- Claude role
- Time required
...
- **Task 1 (Guided):** I learned the 4D pipeline by following explicit steps on a provided scenario. The answer key showed me the correct governance classification and task type selection. By the end, I understood what each stage does.
...
- **Human-AI Balance Definitions** (Hand It Off / Draft Together / Figure It Out Together; formerly Automation/Augmentation/Agency)
