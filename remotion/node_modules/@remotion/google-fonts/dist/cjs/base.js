...
const loadFonts = (meta, style, options) => {
    ...
    for (const style of styles) {
        ...
        for (const weight of weights) {
            ...
            const subsets = (_d = options === null || options === void 0 ? void 0 : options.subsets) !== null && _d !== void 0 ? _d : Object.keys(meta.fonts[style][weight]);
