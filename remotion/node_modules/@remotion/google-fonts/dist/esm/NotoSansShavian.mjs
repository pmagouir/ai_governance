...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        shavian: "https://fonts.gstatic.com/s/notosansshavian/v18/CHy5V_HZE0jxJBQlqAeCKjJvQBNF4HEaQJhf2A.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/notosansshavian/v18/CHy5V_HZE0jxJBQlqAeCKjJvQBNF4HFZQJhf2A.woff2",
        latin: "https://fonts.gstatic.com/s/notosansshavian/v18/CHy5V_HZE0jxJBQlqAeCKjJvQBNF4HFXQJg.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "shavian"]
});
var fontFamily = "Noto Sans Shavian";
