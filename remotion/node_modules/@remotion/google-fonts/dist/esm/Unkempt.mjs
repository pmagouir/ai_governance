...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        latin: "https://fonts.gstatic.com/s/unkempt/v22/2EbnL-Z2DFZue0DSeYEV8g.woff2"
      },
      "700": {
        latin: "https://fonts.gstatic.com/s/unkempt/v22/2EbiL-Z2DFZue0DScTow5zK5qg.woff2"
      }
    }
  },
  subsets: ["latin"]
});
var fontFamily = "Unkempt";
