...
var getInfo = () => ({
  ...
  importName: "SedanSC",
  version: "v2",
  url: "https://fonts.googleapis.com/css2?family=Sedan+SC:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/sedansc/v2/yMJRMIlvYZ3Jn1Y30Aq1dy1Jiw.woff2",
        latin: "https://fonts.gstatic.com/s/sedansc/v2/yMJRMIlvYZ3Jn1Y30Aq7dy0.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Sedan SC";
