...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/slabo13px/v17/11hEGp_azEvXZUdSBzzRQK6h2jkY.woff2",
        latin: "https://fonts.gstatic.com/s/slabo13px/v17/11hEGp_azEvXZUdSBzzRQKCh2g.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Slabo OneThreepx";
