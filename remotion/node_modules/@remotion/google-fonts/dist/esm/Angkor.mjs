...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        khmer: "https://fonts.gstatic.com/s/angkor/v35/H4cmBXyAlsPdnlbO_iY_0Lo.woff2",
        latin: "https://fonts.gstatic.com/s/angkor/v35/H4cmBXyAlsPdnlbO9SY_.woff2"
      }
    }
  },
  subsets: ["khmer", "latin"]
});
var fontFamily = "Angkor";
