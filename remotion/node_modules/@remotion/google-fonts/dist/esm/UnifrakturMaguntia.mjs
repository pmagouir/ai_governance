...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        latin: "https://fonts.gstatic.com/s/unifrakturmaguntia/v22/WWXPlieVYwiGNomYU-ciRLRvEmK7oaVemGZM.woff2"
      }
    }
  },
  subsets: ["latin"]
});
var fontFamily = "UnifrakturMaguntia";
