...
// src/HedvigLettersSans.ts
var getInfo = () => ({
  fontFamily: "Hedvig Letters Sans",
  importName: "HedvigLettersSans",
  version: "v2",
  url: "https://fonts.googleapis.com/css2?family=Hedvig+Letters+Sans:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        math: "https://fonts.gstatic.com/s/hedvigletterssans/v2/CHy_V_PfGVjobSBkihHWDT98RVp37w8jcOZH3Awg.woff2",
        symbols: "https://fonts.gstatic.com/s/hedvigletterssans/v2/CHy_V_PfGVjobSBkihHWDT98RVp37w8jcPRH3Awg.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/hedvigletterssans/v2/CHy_V_PfGVjobSBkihHWDT98RVp37w8jcJRH3Awg.woff2",
        latin: "https://fonts.gstatic.com/s/hedvigletterssans/v2/CHy_V_PfGVjobSBkihHWDT98RVp37w8jcJpH3A.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "math", "symbols"]
});
var fontFamily = "Hedvig Letters Sans";
