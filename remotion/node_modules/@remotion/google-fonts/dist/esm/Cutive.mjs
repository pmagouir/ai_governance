...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/cutive/v24/NaPZcZ_fHOhV3IpLRvJCkyo.woff2",
        latin: "https://fonts.gstatic.com/s/cutive/v24/NaPZcZ_fHOhV3IpLSPJC.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Cutive";
