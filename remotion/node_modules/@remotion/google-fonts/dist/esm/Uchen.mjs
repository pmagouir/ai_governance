...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        tibetan: "https://fonts.gstatic.com/s/uchen/v11/nKKZ-GokGZ1baLaAGwCYdA.woff2",
        latin: "https://fonts.gstatic.com/s/uchen/v11/nKKZ-GokGZ1baLaVGwA.woff2"
      }
    }
  },
  subsets: ["latin", "tibetan"]
});
var fontFamily = "Uchen";
