...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        syriac: "https://fonts.gstatic.com/s/ramsina/v2/daaYSTE-LGmCbhP9yMo_QrmM.woff2",
        latin: "https://fonts.gstatic.com/s/ramsina/v2/daaYSTE-LGmCbhP9yLk_Qg.woff2"
      }
    }
  },
  subsets: ["latin", "syriac"]
});
var fontFamily = "Ramsina";
