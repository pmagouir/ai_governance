...
var getInfo = () => ({
  ...
  importName: "Freeman",
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Freeman:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        vietnamese: "https://fonts.gstatic.com/s/freeman/v1/S6u9w4NGQiLN8nh-SwePGR_p.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/freeman/v1/S6u9w4NGQiLN8nh-SwaPGR_p.woff2",
        latin: "https://fonts.gstatic.com/s/freeman/v1/S6u9w4NGQiLN8nh-SwiPGQ.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "vietnamese"]
});
var fontFamily = "Freeman";
