...
// src/NotoSerifMakasar.ts
var getInfo = () => ({
  fontFamily: "Noto Serif Makasar",
  importName: "NotoSerifMakasar",
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Noto+Serif+Makasar:ital,wght@0,400",
  unicodeRanges: {
    makasar: "U+11EE0-11EF8",
  ...
  fonts: {
    normal: {
      "400": {
        makasar: "https://fonts.gstatic.com/s/notoserifmakasar/v1/memjYbqtyH-NiZpFH_9zcvB_PqkfY9SLIqr3WBCH.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/notoserifmakasar/v1/memjYbqtyH-NiZpFH_9zcvB_PqkfY9SLhovSZSk.woff2",
        latin: "https://fonts.gstatic.com/s/notoserifmakasar/v1/memjYbqtyH-NiZpFH_9zcvB_PqkfY9SLiIvS.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "makasar"]
});
var fontFamily = "Noto Serif Makasar";
