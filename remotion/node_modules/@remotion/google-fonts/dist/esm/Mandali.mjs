...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        telugu: "https://fonts.gstatic.com/s/mandali/v16/LhWlMVbYOfASNfNUZEI_Zcdc.woff2",
        latin: "https://fonts.gstatic.com/s/mandali/v16/LhWlMVbYOfASNfNUZF4_ZQ.woff2"
      }
    }
  },
  subsets: ["latin", "telugu"]
});
var fontFamily = "Mandali";
