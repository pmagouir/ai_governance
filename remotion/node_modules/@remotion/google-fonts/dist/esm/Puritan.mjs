...
var getInfo = () => ({
  ...
  fonts: {
    italic: {
      "400": {
        latin: "https://fonts.gstatic.com/s/puritan/v25/845aNMgkAJ2VTtIoxJjKRv6M.woff2"
      },
      "700": {
        latin: "https://fonts.gstatic.com/s/puritan/v25/845fNMgkAJ2VTtIoxJjC_duZ-GLC.woff2"
      }
    },
    normal: {
      "400": {
        latin: "https://fonts.gstatic.com/s/puritan/v25/845YNMgkAJ2VTtIoxJ36RA.woff2"
      },
      "700": {
        latin: "https://fonts.gstatic.com/s/puritan/v25/845dNMgkAJ2VTtIozCbfUdmp-g.woff2"
      }
    }
  },
  subsets: ["latin"]
});
var fontFamily = "Puritan";
