...
var getInfo = () => ({
  ...
  version: "v2",
  url: "https://fonts.googleapis.com/css2?family=Protest+Riot:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        math: "https://fonts.gstatic.com/s/protestriot/v2/d6lPkaOxWMKm7TdezXFmpkr8rPhhvmQ.woff2",
        symbols: "https://fonts.gstatic.com/s/protestriot/v2/d6lPkaOxWMKm7TdezXFmpkr8vvhhvmQ.woff2",
        vietnamese: "https://fonts.gstatic.com/s/protestriot/v2/d6lPkaOxWMKm7TdezXFmpkr83_hhvmQ.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/protestriot/v2/d6lPkaOxWMKm7TdezXFmpkr83vhhvmQ.woff2",
        latin: "https://fonts.gstatic.com/s/protestriot/v2/d6lPkaOxWMKm7TdezXFmpkr80Phh.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "math", "symbols", "vietnamese"]
});
var fontFamily = "Protest Riot";
