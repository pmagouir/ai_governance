...
// src/Jersey20.ts
var getInfo = () => ({
  fontFamily: "Jersey TwoZero",
  importName: "Jersey20",
  version: "v4",
  url: "https://fonts.googleapis.com/css2?family=Jersey+20:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/jersey20/v4/ZgNRjP1ON6jeW4D12z3spUXrD4k.woff2",
        latin: "https://fonts.gstatic.com/s/jersey20/v4/ZgNRjP1ON6jeW4D12z3sq0Xr.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Jersey TwoZero";
