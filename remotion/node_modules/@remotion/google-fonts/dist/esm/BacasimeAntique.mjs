...
// src/BacasimeAntique.ts
var getInfo = () => ({
  fontFamily: "Bacasime Antique",
  importName: "BacasimeAntique",
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Bacasime+Antique:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/bacasimeantique/v1/tDbX2pGXkFYEykldjZSrmI6T_XWZCw2nSHrV.woff2",
        latin: "https://fonts.gstatic.com/s/bacasimeantique/v1/tDbX2pGXkFYEykldjZSrmI6T_XWZCwOnSA.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Bacasime Antique";
