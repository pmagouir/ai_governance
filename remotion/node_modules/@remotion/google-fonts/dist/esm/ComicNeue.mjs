...
var getInfo = () => ({
  ...
  fonts: {
    italic: {
      "300": {
        latin: "https://fonts.gstatic.com/s/comicneue/v9/4UaarEJDsxBrF37olUeD96_RTplkLCND.woff2"
      },
      "400": {
        latin: "https://fonts.gstatic.com/s/comicneue/v9/4UaFrEJDsxBrF37olUeD96_Z5btx.woff2"
      },
      "700": {
        latin: "https://fonts.gstatic.com/s/comicneue/v9/4UaarEJDsxBrF37olUeD96_RXp5kLCND.woff2"
      }
    },
    normal: {
      "300": {
        latin: "https://fonts.gstatic.com/s/comicneue/v9/4UaErEJDsxBrF37olUeD_wHL8pxULg.woff2"
      },
      "400": {
        latin: "https://fonts.gstatic.com/s/comicneue/v9/4UaHrEJDsxBrF37olUeD96rp5w.woff2"
      },
      "700": {
        latin: "https://fonts.gstatic.com/s/comicneue/v9/4UaErEJDsxBrF37olUeD_xHM8pxULg.woff2"
      }
    }
  },
  subsets: ["latin"]
});
var fontFamily = "Comic Neue";
