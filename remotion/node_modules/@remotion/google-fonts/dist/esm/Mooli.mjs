...
var getInfo = () => ({
  ...
  importName: "Mooli",
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Mooli:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/mooli/v1/-F6_fjJpLyk1bbPIDm_opw.woff2",
        latin: "https://fonts.gstatic.com/s/mooli/v1/-F6_fjJpLyk1bbPGDm8.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Mooli";
