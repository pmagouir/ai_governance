...
// src/Jersey20Charted.ts
var getInfo = () => ({
  fontFamily: "Jersey TwoZero Charted",
  importName: "Jersey20Charted",
  version: "v4",
  url: "https://fonts.googleapis.com/css2?family=Jersey+20+Charted:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/jersey20charted/v4/JTUNjJMy9DKq5FzVaj9tpgYgvHqGn8Z8hC6bqg.woff2",
        latin: "https://fonts.gstatic.com/s/jersey20charted/v4/JTUNjJMy9DKq5FzVaj9tpgYgvHqGn8ZyhC4.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Jersey TwoZero Charted";
