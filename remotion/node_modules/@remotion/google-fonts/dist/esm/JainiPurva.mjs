...
var getInfo = () => ({
  ...
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Jaini+Purva:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        devanagari: "https://fonts.gstatic.com/s/jainipurva/v1/CHynV-vdHVXwbWcUswbUGEoIFn8cjw.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/jainipurva/v1/CHynV-vdHVXwbWcUswbUGEoHFn8cjw.woff2",
        latin: "https://fonts.gstatic.com/s/jainipurva/v1/CHynV-vdHVXwbWcUswbUGEoJFn8.woff2"
      }
    }
  },
  subsets: ["devanagari", "latin", "latin-ext"]
});
var fontFamily = "Jaini Purva";
