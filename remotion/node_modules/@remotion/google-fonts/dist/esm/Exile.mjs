...
var getInfo = () => ({
  ...
  importName: "Exile",
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Exile:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/exile/v1/pxiKyp0xqNtbjCsRFJXGdg.woff2",
        latin: "https://fonts.gstatic.com/s/exile/v1/pxiKyp0xqNtbjCsfFJU.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Exile";
