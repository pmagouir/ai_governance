...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        khmer: "https://fonts.gstatic.com/s/bayon/v36/9XUrlJNmn0LPFm-lMBc0dw.woff2",
        latin: "https://fonts.gstatic.com/s/bayon/v36/9XUrlJNmn0LPFm-uMBc.woff2"
      }
    }
  },
  subsets: ["khmer", "latin"]
});
var fontFamily = "Bayon";
