...
// src/NotoSansZanabazarSquare.ts
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        "zanabazar-square": "https://fonts.gstatic.com/s/notosanszanabazarsquare/v20/Cn-jJsuGWQxOjaGwMQ6fOicyxLBEMRfDtkzl4uagQuL1EwUtDlg.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/notosanszanabazarsquare/v20/Cn-jJsuGWQxOjaGwMQ6fOicyxLBEMRfDtkzl4uagQuJ4MiAQNw.woff2",
        latin: "https://fonts.gstatic.com/s/notosanszanabazarsquare/v20/Cn-jJsuGWQxOjaGwMQ6fOicyxLBEMRfDtkzl4uagQuJ2MiA.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "zanabazar-square"]
});
var fontFamily = "Noto Sans Zanabazar Square";
