...
// src/Jersey10Charted.ts
var getInfo = () => ({
  fontFamily: "Jersey OneZero Charted",
  importName: "Jersey10Charted",
  version: "v4",
  url: "https://fonts.googleapis.com/css2?family=Jersey+10+Charted:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/jersey10charted/v4/oY1E8fPFr6XiNWqEp90XSbwUGfF8SkeUIGaxvA.woff2",
        latin: "https://fonts.gstatic.com/s/jersey10charted/v4/oY1E8fPFr6XiNWqEp90XSbwUGfF8SkeaIGY.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Jersey OneZero Charted";
