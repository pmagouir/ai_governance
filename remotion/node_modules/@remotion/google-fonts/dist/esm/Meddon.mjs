...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/meddon/v27/kmK8ZqA2EgDNeHTpjR1A7y8.woff2",
        latin: "https://fonts.gstatic.com/s/meddon/v27/kmK8ZqA2EgDNeHTpgx1A.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Meddon";
