...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        manichaean: "https://fonts.gstatic.com/s/notosansmanichaean/v19/taiVGntiC4--qtsfi4Jp9-_GkPZZCcrfenr-Pzp1Cg.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/notosansmanichaean/v19/taiVGntiC4--qtsfi4Jp9-_GkPZZCcrfenqLPzp1Cg.woff2",
        latin: "https://fonts.gstatic.com/s/notosansmanichaean/v19/taiVGntiC4--qtsfi4Jp9-_GkPZZCcrfenqFPzo.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "manichaean"]
});
var fontFamily = "Noto Sans Manichaean";
