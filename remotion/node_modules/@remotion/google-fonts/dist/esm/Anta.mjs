...
var getInfo = () => ({
  ...
  importName: "Anta",
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Anta:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        math: "https://fonts.gstatic.com/s/anta/v1/gyBzhwQ3KsIyVCc7PWim.woff2",
        symbols: "https://fonts.gstatic.com/s/anta/v1/gyBzhwQ3KsIyVDU7PWim.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/anta/v1/gyBzhwQ3KsIyVFU7PWim.woff2",
        latin: "https://fonts.gstatic.com/s/anta/v1/gyBzhwQ3KsIyVFs7PQ.woff2"
      }
    }
  },
