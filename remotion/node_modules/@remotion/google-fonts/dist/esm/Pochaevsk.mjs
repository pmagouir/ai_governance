...
var getInfo = () => ({
  ...
  version: "v5",
  url: "https://fonts.googleapis.com/css2?family=Pochaevsk:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "cyrillic-ext": "https://fonts.gstatic.com/s/pochaevsk/v5/55xuey9_OdX_Om7ReYgVqp15ybk.woff2",
        cyrillic: "https://fonts.gstatic.com/s/pochaevsk/v5/55xuey9_OdX_Om7ReYgVo515ybk.woff2",
        latin: "https://fonts.gstatic.com/s/pochaevsk/v5/55xuey9_OdX_Om7ReYgVp515.woff2"
      }
    }
  },
  subsets: ["cyrillic", "cyrillic-ext", "latin"]
});
var fontFamily = "Pochaevsk";
