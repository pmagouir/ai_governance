...
var getInfo = () => ({
  ...
  importName: "Boldonse",
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Boldonse:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/boldonse/v1/ZgNQjPxGPbbJUZemjB31jGDWNg.woff2",
        latin: "https://fonts.gstatic.com/s/boldonse/v1/ZgNQjPxGPbbJUZemjB37jGA.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Boldonse";
