...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        tifinagh: "https://fonts.gstatic.com/s/notosanstifinagh/v21/I_uzMoCduATTei9eI8dawkHIwvmhCvbXzbPFQXc.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/notosanstifinagh/v21/I_uzMoCduATTei9eI8dawkHIwvmhCvbX47PFQXc.woff2",
        latin: "https://fonts.gstatic.com/s/notosanstifinagh/v21/I_uzMoCduATTei9eI8dawkHIwvmhCvbX7bPF.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "tifinagh"]
});
var fontFamily = "Noto Sans Tifinagh";
