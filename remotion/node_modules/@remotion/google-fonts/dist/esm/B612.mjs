...
var getInfo = () => ({
  ...
  fonts: {
    italic: {
      "400": {
        latin: "https://fonts.gstatic.com/s/b612/v13/3Jn8SDDxiSz36juCGxCk.woff2"
      },
      "700": {
        latin: "https://fonts.gstatic.com/s/b612/v13/3Jn_SDDxiSz36juKoDWxTl0A.woff2"
      }
    },
    normal: {
      "400": {
      ...
      "700": {
        latin: "https://fonts.gstatic.com/s/b612/v13/3Jn9SDDxiSz34oWXDDeBTA.woff2"
      }
    }
  },
  subsets: ["latin"]
});
var fontFamily = "BSixOneTwo";
