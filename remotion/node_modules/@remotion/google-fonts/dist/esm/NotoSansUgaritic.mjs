...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        ugaritic: "https://fonts.gstatic.com/s/notosansugaritic/v17/3qTwoiqhnSyU8TNFIdhZVCwbjCpkAXXUfBAJoiY.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/notosansugaritic/v17/3qTwoiqhnSyU8TNFIdhZVCwbjCpkAXXUOxAJoiY.woff2",
        latin: "https://fonts.gstatic.com/s/notosansugaritic/v17/3qTwoiqhnSyU8TNFIdhZVCwbjCpkAXXUNRAJ.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "ugaritic"]
});
var fontFamily = "Noto Sans Ugaritic";
