...
// src/BadeenDisplay.ts
var getInfo = () => ({
  fontFamily: "Badeen Display",
  importName: "BadeenDisplay",
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Badeen+Display:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        arabic: "https://fonts.gstatic.com/s/badeendisplay/v1/pxidypY2sdZSjFU4cPmNBzckaeeJaEx8qw.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/badeendisplay/v1/pxidypY2sdZSjFU4cPmNBzckaeeCaEx8qw.woff2",
        latin: "https://fonts.gstatic.com/s/badeendisplay/v1/pxidypY2sdZSjFU4cPmNBzckaeeMaEw.woff2"
      }
    }
  },
  subsets: ["arabic", "latin", "latin-ext"]
});
var fontFamily = "Badeen Display";
