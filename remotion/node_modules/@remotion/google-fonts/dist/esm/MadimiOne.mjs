...
var getInfo = () => ({
  ...
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Madimi+One:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        math: "https://fonts.gstatic.com/s/madimione/v1/2V0YKIEADpA8U6RygDnZVC8iB7HM.woff2",
        symbols: "https://fonts.gstatic.com/s/madimione/v1/2V0YKIEADpA8U6RygDnZVD0iB7HM.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/madimione/v1/2V0YKIEADpA8U6RygDnZVF0iB7HM.woff2",
        latin: "https://fonts.gstatic.com/s/madimione/v1/2V0YKIEADpA8U6RygDnZVFMiBw.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "math", "symbols"]
});
var fontFamily = "Madimi One";
