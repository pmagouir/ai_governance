...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        khmer: "https://fonts.gstatic.com/s/metal/v32/lW-wwjUJIXTo7h3rlIUwUQ.woff2",
        latin: "https://fonts.gstatic.com/s/metal/v32/lW-wwjUJIXTo7h3glIU.woff2"
      }
    }
  },
  subsets: ["khmer", "latin"]
});
var fontFamily = "Metal";
