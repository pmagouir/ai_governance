...
var getInfo = () => ({
  ...
  fonts: {
    italic: {
      "400": {
        latin: "https://fonts.gstatic.com/s/arvo/v23/tDbN2oWUg0MKqSIg75Tv.woff2"
      },
      "700": {
        latin: "https://fonts.gstatic.com/s/arvo/v23/tDbO2oWUg0MKqSIoVLH68dr_.woff2"
      }
    },
    normal: {
      "400": {
      ...
      "700": {
        latin: "https://fonts.gstatic.com/s/arvo/v23/tDbM2oWUg0MKoZw1-LPK8w.woff2"
      }
    }
  },
  subsets: ["latin"]
