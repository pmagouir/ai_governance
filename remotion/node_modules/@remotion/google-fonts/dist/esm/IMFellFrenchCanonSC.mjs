...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        latin: "https://fonts.gstatic.com/s/imfellfrenchcanonsc/v23/FBVmdCru5-ifcor2bgq9V89khWcmQghEURY7H0czWhE.woff2"
      }
    }
  },
  subsets: ["latin"]
});
var fontFamily = "IM Fell French Canon SC";
