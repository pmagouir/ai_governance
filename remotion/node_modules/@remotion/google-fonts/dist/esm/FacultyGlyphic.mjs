...
// src/FacultyGlyphic.ts
var getInfo = () => ({
  fontFamily: "Faculty Glyphic",
  importName: "FacultyGlyphic",
  version: "v4",
  url: "https://fonts.googleapis.com/css2?family=Faculty+Glyphic:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/facultyglyphic/v4/RrQIbot2-iBvI2mYSyKIrcgoBuQ4Eu2EBVk.woff2",
        latin: "https://fonts.gstatic.com/s/facultyglyphic/v4/RrQIbot2-iBvI2mYSyKIrcgoBuQ4HO2E.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Faculty Glyphic";
