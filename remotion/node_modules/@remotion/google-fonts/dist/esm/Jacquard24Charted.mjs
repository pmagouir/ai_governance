...
// src/Jacquard24Charted.ts
var getInfo = () => ({
  fontFamily: "Jacquard TwoFour Charted",
  importName: "Jacquard24Charted",
  version: "v5",
  url: "https://fonts.googleapis.com/css2?family=Jacquard+24+Charted:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/jacquard24charted/v5/mtGm4-dNK6HaudrE9VVKhENTsEXEYish4i1hMLJ_.woff2",
        latin: "https://fonts.gstatic.com/s/jacquard24charted/v5/mtGm4-dNK6HaudrE9VVKhENTsEXEYish4iNhMA.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Jacquard TwoFour Charted";
