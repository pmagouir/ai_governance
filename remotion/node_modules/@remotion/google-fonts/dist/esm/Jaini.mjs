...
var getInfo = () => ({
  ...
  importName: "Jaini",
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Jaini:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        devanagari: "https://fonts.gstatic.com/s/jaini/v1/fC1vPYJMbGHQzHmIIediUA.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/jaini/v1/fC1vPYJMbGHQzHmHIediUA.woff2",
        latin: "https://fonts.gstatic.com/s/jaini/v1/fC1vPYJMbGHQzHmJIec.woff2"
      }
    }
  },
  subsets: ["devanagari", "latin", "latin-ext"]
});
var fontFamily = "Jaini";
