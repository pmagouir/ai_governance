...
var getInfo = () => ({
  ...
  importName: "AntonSC",
  version: "v1",
  url: "https://fonts.googleapis.com/css2?family=Anton+SC:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        vietnamese: "https://fonts.gstatic.com/s/antonsc/v1/4UaBrEBBsgltGn71syLux6jx4w.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/antonsc/v1/4UaBrEBBsgltGn71syLvx6jx4w.woff2",
        latin: "https://fonts.gstatic.com/s/antonsc/v1/4UaBrEBBsgltGn71syLhx6g.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "vietnamese"]
});
var fontFamily = "Anton SC";
