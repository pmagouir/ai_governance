...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        khmer: "https://fonts.gstatic.com/s/bokor/v32/m8JcjfpeeaqTiS2afojrcQ.woff2",
        latin: "https://fonts.gstatic.com/s/bokor/v32/m8JcjfpeeaqTiS2Rfog.woff2"
      }
    }
  },
  subsets: ["khmer", "latin"]
});
var fontFamily = "Bokor";
