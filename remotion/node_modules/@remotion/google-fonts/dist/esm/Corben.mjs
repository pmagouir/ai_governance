...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/corben/v23/LYjDdGzzklQtCMpNqQNFlVs.woff2",
        latin: "https://fonts.gstatic.com/s/corben/v23/LYjDdGzzklQtCMpNpwNF.woff2"
      },
      "700": {
        "latin-ext": "https://fonts.gstatic.com/s/corben/v23/LYjAdGzzklQtCMpFHCZQpHoqbN4.woff2",
        latin: "https://fonts.gstatic.com/s/corben/v23/LYjAdGzzklQtCMpFHCZQqnoq.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Corben";
