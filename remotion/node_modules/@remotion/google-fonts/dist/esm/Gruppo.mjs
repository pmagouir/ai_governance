...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/gruppo/v23/WwkfxPmzE06v_ZW1UHrBCIE.woff2",
        latin: "https://fonts.gstatic.com/s/gruppo/v23/WwkfxPmzE06v_ZW1XnrB.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Gruppo";
