...
// src/Jersey10.ts
var getInfo = () => ({
  fontFamily: "Jersey OneZero",
  importName: "Jersey10",
  version: "v4",
  url: "https://fonts.googleapis.com/css2?family=Jersey+10:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/jersey10/v4/GftH7vZKsggXMf9n_J5n8Zjh-1w.woff2",
        latin: "https://fonts.gstatic.com/s/jersey10/v4/GftH7vZKsggXMf9n_J5n_5jh.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Jersey OneZero";
