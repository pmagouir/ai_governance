...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        khmer: "https://fonts.gstatic.com/s/odormeanchey/v31/raxkHiKDttkTe1aOGcJMR1A_4lrU0TukKQ.woff2",
        latin: "https://fonts.gstatic.com/s/odormeanchey/v31/raxkHiKDttkTe1aOGcJMR1A_4lrf0Ts.woff2"
      }
    }
  },
  subsets: ["khmer", "latin"]
});
var fontFamily = "Odor Mean Chey";
