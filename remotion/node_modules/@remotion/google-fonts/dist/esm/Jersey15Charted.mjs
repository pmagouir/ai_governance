...
// src/Jersey15Charted.ts
var getInfo = () => ({
  fontFamily: "Jersey OneFive Charted",
  importName: "Jersey15Charted",
  version: "v4",
  url: "https://fonts.googleapis.com/css2?family=Jersey+15+Charted:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/jersey15charted/v4/nuFjD-rCQIjoVp1Sva2ToCTudGbLeSvxpWwG4g.woff2",
        latin: "https://fonts.gstatic.com/s/jersey15charted/v4/nuFjD-rCQIjoVp1Sva2ToCTudGbLeSv_pWw.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "Jersey OneFive Charted";
