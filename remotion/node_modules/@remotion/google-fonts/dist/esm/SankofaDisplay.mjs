...
// src/SankofaDisplay.ts
var getInfo = () => ({
  fontFamily: "Sankofa Display",
  importName: "SankofaDisplay",
  version: "v2",
  url: "https://fonts.googleapis.com/css2?family=Sankofa+Display:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        vietnamese: "https://fonts.gstatic.com/s/sankofadisplay/v2/Ktk1ALSRd4LucUDghJ2rTqXOoh3HH6OYZY8.woff2",
        "latin-ext": "https://fonts.gstatic.com/s/sankofadisplay/v2/Ktk1ALSRd4LucUDghJ2rTqXOoh3HHqOYZY8.woff2",
        latin: "https://fonts.gstatic.com/s/sankofadisplay/v2/Ktk1ALSRd4LucUDghJ2rTqXOoh3HEKOY.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext", "vietnamese"]
});
var fontFamily = "Sankofa Display";
