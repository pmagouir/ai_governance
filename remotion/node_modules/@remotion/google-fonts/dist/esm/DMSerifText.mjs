...
var getInfo = () => ({
  ...
  fonts: {
    italic: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/dmseriftext/v13/rnCw-xZa_krGokauCeNq1wWyWfG1UVoNMrY.woff2",
        latin: "https://fonts.gstatic.com/s/dmseriftext/v13/rnCw-xZa_krGokauCeNq1wWyWfG1X1oN.woff2"
      }
    },
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/dmseriftext/v13/rnCu-xZa_krGokauCeNq1wWyWfqFXUIJ.woff2",
        latin: "https://fonts.gstatic.com/s/dmseriftext/v13/rnCu-xZa_krGokauCeNq1wWyWfSFXQ.woff2"
      }
    }
  },
  subsets: ["latin", "latin-ext"]
});
var fontFamily = "DM Serif Text";
