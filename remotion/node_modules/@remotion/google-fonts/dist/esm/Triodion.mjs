...
var getInfo = () => ({
  ...
  importName: "Triodion",
  version: "v3",
  url: "https://fonts.googleapis.com/css2?family=Triodion:ital,wght@0,400",
  unicodeRanges: {
  ...
  fonts: {
    normal: {
      "400": {
        "cyrillic-ext": "https://fonts.gstatic.com/s/triodion/v3/IFSnHe5TgMVEmMQV5lrzseSF0g.woff2",
        cyrillic: "https://fonts.gstatic.com/s/triodion/v3/IFSnHe5TgMVEmMQV5lr6seSF0g.woff2",
        latin: "https://fonts.gstatic.com/s/triodion/v3/IFSnHe5TgMVEmMQV5lr-seQ.woff2"
      }
    }
  },
  subsets: ["cyrillic", "cyrillic-ext", "latin"]
});
var fontFamily = "Triodion";
