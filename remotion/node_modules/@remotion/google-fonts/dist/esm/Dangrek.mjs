...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        khmer: "https://fonts.gstatic.com/s/dangrek/v33/LYjCdG30nEgoH8E2sC9gqGIu.woff2",
        latin: "https://fonts.gstatic.com/s/dangrek/v33/LYjCdG30nEgoH8E2sCRgqA.woff2"
      }
    }
  },
  subsets: ["khmer", "latin"]
});
var fontFamily = "Dangrek";
