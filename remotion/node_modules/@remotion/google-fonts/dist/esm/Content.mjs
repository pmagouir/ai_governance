...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        khmer: "https://fonts.gstatic.com/s/content/v27/zrfl0HLayePhU_AwYaz4Iw.woff2"
      },
      "700": {
        khmer: "https://fonts.gstatic.com/s/content/v27/zrfg0HLayePhU_AwaRzdNibVWQ.woff2"
      }
    }
  },
  subsets: ["khmer"]
});
var fontFamily = "Content";
